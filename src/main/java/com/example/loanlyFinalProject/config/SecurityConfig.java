...
public class SecurityConfig {
        ...
        .authorizeHttpRequests(
            auth ->
                auth.requestMatchers(PUBLIC_ENDPOINTS)
                    ...
                    .hasAnyRole("SUPER_ADMIN", "MARKETING")
                    .requestMatchers("/api/branch-manager/**")
                    .hasAnyRole("SUPER_ADMIN", "BRANCH_MANAGER")
                    .requestMatchers("/api/back-office/**")
                    .hasAnyRole("SUPER_ADMIN", "BACK_OFFICE")
  ...
  public CorsConfigurationSource corsConfigurationSource() {
    ...
    configuration.setAllowedOrigins(
        List.of("https://fe-loanlyfinalproject.vercel.app", "http://localhost:4200"));
